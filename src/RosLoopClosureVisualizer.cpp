...
RosLoopClosureVisualizer::RosLoopClosureVisualizer() : 
  ...
  posegraph_pub_ = nh_.advertise<pose_graph_tools_msgs::PoseGraph>("pose_graph", 1);
  ...
  bow_query_pub_ = nh_.advertise<pose_graph_tools_msgs::BowQueries>("bow_query", 1000);
  vlc_frame_pub_ = nh_.advertise<pose_graph_tools_msgs::VLCFrames>("vlc_frames", 100);
  // Service
