...
class RosLoopClosureVisualizer {
 ...
 private:
  ...
  bool VLCServiceCallback(pose_graph_tools_msgs::VLCFrameQuery::Request& request,
 ...
 private:
  ...
  bool getFrameMsg(int pose_id, pose_graph_tools_msgs::VLCFrameMsg& frame_msg) const;
